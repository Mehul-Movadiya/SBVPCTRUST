...
// $("[data-toggle=tooltip]").tooltip();
  ...
  <body>
    ...
    <div class="container-fluid bg-primary mb-5">
      ...
      >
        <h3 class="display-3 font-weight-bold text-white">Members</h3>
      ...
      <div class="container">
        <div class="text-center pb-2">
          <p class="section-title px-5">
            <span class="px-2">Our Members</span>
          </p>
      ...
      <div class="row pt-5">
        <div class="col-lg-3 col-md-6 mb-5">
          ...
          <a href="index.php" class="navbar-brand font-weight-bold text-secondary">
            ...
            <!-- <h4 style="color:skyblue; vertical-align: top;" class="d-inline-block py-4"><b>શ્રી સમસ્ત બાવનગોળ વાટલિયા </br><h4 style="color:skyblue;">&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspપ્રજાપતિ સમાજ</h4></b></h4> -->
            <span class="text-white"><div style="text-align: center;margin-top: 20px;">સર્વ બાવનગોળ વાટલિયા<br>પ્રજાપતિ ચેરીટેબલ સમાજ</div></span>
        </a>
