...
?>    <!-- Header Start -->
    <div class="container-fluid bg-primary mb-5">
      ...
      >
        <h3 class="display-3 font-weight-bold text-white">Our Events</h3>
        <div class="d-inline-flex text-white">
          <p class="m-0"><a class="text-white" href="">Home</a></p>
          <p class="m-0 px-2">/</p>
          <p class="m-0">Our Events</p>
        </div>
      </div>
    </div>
    <!-- Header End -->
      ...
      <div class="container">
        <div class="text-center pb-2">
          <p class="section-title px-5">
            <span class="px-2">Latest Events</span>
          </p>
          <h1 class="mb-4">Latest Details From Events</h1>
        </div>
        <div class="row pb-3">
        <?php 
$data = $conn->query("select *  from function_view");
